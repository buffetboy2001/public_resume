...
* a proud member of the technical staff at the [MITRE Corporation](https://www.mitre.org);
...
* Aviation, Avionics, Flight Management System, Guidance, Navigation, Control, Robotics, Algorithms

# Research Engineer @ MITRE

My background is in the science of flight and that has been the main focus of my work at MITRE: commercial aviation. The essential work of my career has been to practice two deeply technical fields and bring them together: aerospace engineering and software engineering. I do this by building scientific simulations that enable scientifically defensible & reproducible research. I do this by staying close to both disciplines simultaneously.
...
At [MITRE Corporation](https://www.mitre.org) I've been involved in two major efforts that has produced important open-source code for the civil aviation community. Take a look if you're so inclined.
...
* Robotics Instructor @ [Cornerstone Classical Academy](https://cornerstoneclassicalroanoke.org/faculty) in Roanoke, VA.
* You can find out more about me at my blog: [aerosci.dev](https://www.aerosci.dev).

# Before MITRE

**8/2004- 2/2008** | Systems Engineer with TOP SECRET (SCI) clearance | [SAIC, Inc.](https://www.saic.com/), Crystal City, VA
...
2001 | Master of Science | University Of Maryland College Park
...
1999 | Bachelor of Science | University Of Maryland College Park

Concentration: Aerospace Engineering, Graduated Magna Cum Laude (3.86/4.0)
